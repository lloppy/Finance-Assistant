...
class AddBillCategoryScreen : ComponentActivity() {
    @SuppressLint("NewApi")
...
private fun AddCategoryScreen(onCategoryAdded: () -> Unit) {
    Column(
        ...
        Button(onClick = {
            if (!defaultBillCategories.contains(categoryName) && categoryName!="") {
                defaultBillCategories += categoryName.replaceFirstChar {
